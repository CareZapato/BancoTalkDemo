...
export const FORMATO_RESPUESTAS = "Se entregará un texto que resume la peticion de una persona que lo llamaremos TextoEntrada del cual se puede deducir que quiere una de las 2 opciones: A) Pagar deudas que tiene asociadas; B) Preguntas sobre sus deudas; De ambas quiero obtener un texto llamaremos TextoSalida con unos formato específicos descritos a continuación:"+ 
...
"1) El texto puede decir que quiere pagar todas sus deudas, como por ejemplo, 'necesito pagar todas mis deudas' o 'quiero liberarme de las tarjetas'. En este caso se asume que quiere pagar todo de todas las deudas que tenga asociado y el TextoSalida debe ser el siguiente: ;Deu-T;rut."+
"2) El texto puede decir que quiere pagar solo ciertas deudas, como por ejemplo, 'quiero (necesito) pagar la tarjeta visa' o 'necesito pagar mi tarjeta falabella y ripley'. Esto puede repetirse dentro del texto varias veces nombrando distintas entidades. En este caso el TextoSalida que necesito para N entidades nombradas es: ;Deu-A;nombre_entidad_01;nombre_entidad_02;nombre_entidad_03;nombre_entidad_04;nombre_entidad_N;rut."+
"3) El texto puede decir que quiere pagar solo un monto de cierta deuda, puede decirlo repetidamente si son distintas entidades, como por ejemplo, 'quiero pagar de la tarjeta visa 3000 y de la tarjeta mastercard 10000.' o tambien agregar, 'Tambien el total de la tarjeta falabella'. Esto puede repetirse y variar dentro del texto varias veces nombrando distintas entidades y distintos montos. En este caso el TextoSalida que necesito para N entidades nombradas es: ;Deu-AM;nombre_entidad_01;monto_01;nombre_entidad_02;monto_02;nombre_entidad_03;monto_03;nombre_entidad_04;monto_04;nombre_entidad_N;monto_n;rut. Tener en cuenta que si no nombra el monto se asume que es el total de la deuda de esa tarjeta y eso hara que el el valor monto sea reemplazado por 'Total'. Lo mismo si dice que quiere pagar el total de la deuda."+
...
"Recuerda que sólo debe entregarme el TextoSalida dependiendo las descipciones descritas. Los ejemplos pueden tener muchas variedades pero eso no debe haver variar el formato de TextoSalida esperado.";
